 ...
 * @author user-ubunto
 */
@WebServlet(name = "saveTransactionsNClient2", urlPatterns = {"/saveTransactionsNClient2"})
public class saveTransactionsNClient2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<TransactionBalance> transactionsB = clientRDB.getTransactionsByDate(codeAccount, date1, date2);
